...
<body class="main">
	...
	<div id="divad">
		<img src="${pageContext.request.contextPath}/static/images/ad/index_ad.jpg" />
	</div>
		...
		<table width="900px" border="0" cellspacing="0">
			<tr>
				...
				<td style="padding:5px 15px 10px 40px"><table width="100%"
						...
						<tr>
							<td><img src="${pageContext.request.contextPath}/static/images/hottitle.gif" width="126" height="29" />
							</td>
						</tr>
					</table>
					<table width="100%" border="0" cellspacing="0">
						<tr>
							<td style="width:50px; text-align:center"><a href="info.html"><img
									src="${pageContext.request.contextPath}/static/images/bookcover/1.png" width="102" height="130"
									border="0" /> </a><br /> <a href="info.html">TravelBook<br />
									作者:Lonley Plant</a></td>
							<td style="width:50px; text-align:center"><a href="info.html"><img
									src="${pageContext.request.contextPath}/static/images/bookcover/2.png" width="102" height="130" border="0" />
