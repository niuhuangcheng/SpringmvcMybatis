			...
			<tr>
				...
				<td><div style="text-align:right; margin:5px 10px 5px 0px">
						<a href="${pageContext.request.contextPath}/">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;<a
							href="${pageContext.request.contextPath}/cart/cart">&nbsp;购物车</a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;&nbsp;订单
					</div>

					<form id="orderForm" action="CreateOrdersServlet" method="post">
								...
								<td><table width="100%" border="0" cellspacing="0">
										...
										<tr>
											<td><table cellspacing="1" class="carttable">
												...
												<table width="100%" border="0" cellspacing="0">
												<c:forEach var="item" varStatus="vs" items="${cart}">
													<tr>
														<td width="10%">${vs.count }</td>
														<td width="40%">${item.key.name}</td>
														<td width="10%">${item.key.price}</td>
														<td width="10%">${item.key.category}</td>
														<td width="10%"><input name="text" type="text"
															value="${item.value}" style="width:20px" readonly="readonly" /></td>
